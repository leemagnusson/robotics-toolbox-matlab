...
% draw_coordinate_system([20 20 20],R01,[0;0;0],['r' 'g' 'b'],'1');
...
WRIST.Origins{3} = p02;
% draw_coordinate_system([20 20 20],R02,p02,['r' 'g' 'b'],'2');
...
p03 = p02;
WRIST.Origins{4} = p03;
% draw_coordinate_system([20 20 20],R03,p02,['r' 'g' 'b'],'3');
...
R04 = R01*RotationMatrix_rad((beta+gamma)/2,[1;0;0]);
WRIST.R = R04;
p04 = p02 + R04*[0;0;25];
WRIST.p = p04;
...
WRIST.J = [cross(R01(:,2),p04),cross(R02(:,1),p04-p02)
                R01(:,2),R02(:,1)];
