function necessity2015armupdated = importJointPositionsFromURDF(filename, startRow, endRow)
...
%
% Example:
%   necessity2015armupdated = importfile('necessity_2015_arm_updated.urdf.xacro', [90,141,192,243,294,346,397,448,503,558,609], [90,141,192,243,294,346,397,448,503,558,609]);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/06/26 10:27:58

%% Initialize variables.
delimiter = ' ';
if nargin<=2
    startRow = [90,141,192,243,294,346,397,448,503,558,609];
    endRow = [90,141,192,243,294,346,397,448,503,558,609];
end
