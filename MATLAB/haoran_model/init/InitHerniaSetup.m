...
translation_target = rotation_setup * [34.9827;1499.0355;0]*scale_mm_to_m+translation_setup;
...
translation_trocar4 = rotation_setup * [-69.1751;1391.3410;-180.5226]*scale_mm_to_m+translation_setup;

% translation_trocar3 = [-0.05;0.188;1.39];
% translation_trocar4 = translation_trocar3;
...
% rotation_camera = [x_camera,y_camera,z_camera] * RotationAxisAngle([1;0;0],pi);
...
for index = 1 : length(vertex_hernia_macro_workspace{1})
    point_clouds_hernia_workspace(:,index * 3 - 2) = rotation_setup * [vertex_hernia_macro_workspace{1}(1,index);vertex_hernia_macro_workspace{2}(1,index);vertex_hernia_macro_workspace{3}(1,index)] + translation_setup;
    point_clouds_hernia_workspace(:,index * 3 - 1) = rotation_setup * [vertex_hernia_macro_workspace{1}(2,index);vertex_hernia_macro_workspace{2}(2,index);vertex_hernia_macro_workspace{3}(2,index)] + translation_setup;
    point_clouds_hernia_workspace(:,index * 3 - 0) = rotation_setup * [vertex_hernia_macro_workspace{1}(3,index);vertex_hernia_macro_workspace{2}(3,index);vertex_hernia_macro_workspace{3}(3,index)] + translation_setup;
end
% save('..\data\point_clouds_hernia_workspace.mat','point_clouds_hernia_workspace');