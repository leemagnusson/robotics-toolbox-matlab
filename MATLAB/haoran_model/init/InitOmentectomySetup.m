%% Omentectomy measurement
% The omentectomy setup comes from the measurement of CAD model setup in a
...
translation_target = rotation_setup * [-111.07; 1283.14;0]*scale_mm_to_m+translation_setup;
