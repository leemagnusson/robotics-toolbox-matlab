...
R_Trocar1 = R_Trocar1 * rotr([1;0;0],pi/18) * rotr([0;1;0],-pi/18);
R_Trocar2 = [x_Trocar2 y_Trocar2 z_Trocar2];
R_Trocar3 = [x_Trocar3 y_Trocar3 z_Trocar3];
R_Trocar3 = R_Trocar3 * rotr([0;0;1],-2*pi/3) * rotr([0;1;0],-pi/6) * rotr([0;0;1],-pi/3);
...
y_Camera = cross(z_Camera,x_Camera);
R_Camera = [x_Camera,y_Camera,z_Camera];
R_Camera = R_Camera * rotr([1;0;0],pi);
